...
def test(dataset_name, final_subjects, final_videos, dataset, X_all, X1_all, batch_size, micro_threshold,
    ...
    for subject_index in range(len(X_all)):
        ...
        # Spot intervals
        micro_list, macro_list = spotting(dataset_name, final_subjects, final_videos, dataset, result_all,
                                          subject_count, micro_threshold, macro_threshold, dif_threshold, show=False)
