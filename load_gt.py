...
CASME_sq_gt_xlsx_path = "/kaggle/working/MTSN-Spot-ME-MaE-test/megc2021-ground-truth/CASME_sq_gt.xlsx"
SAMMLV_gt_xlsx_path = "/kaggle/working/MTSN-Spot-ME-MaE-test/megc2021-ground-truth/SAMMLV_gt.xlsx"
...
def load_excel(dataset_name):
    if (dataset_name == 'CASME_sq'):
        ...
        xl = pd.ExcelFile(CASME_sq_gt_xlsx_path)  # Specify directory of excel file
        ...
        xl = pd.ExcelFile(SAMMLV_gt_xlsx_path)
